...
//	    else
//			$avatar = $GLOBALS["PIC_BASE_URL"]."disabled_avatar.gif";
        ...
        $GLOBALS["PIC_BASE_URL"]."star.gif\" alt='Donor'>" : "") . ($arr2["enabled"] == "no" ? "<img src=\"".
        $GLOBALS["PIC_BASE_URL"]."disabled.gif\" alt=\"This account is disabled\" style='margin-left: 2px'>" : ($arr2["warned"] == "yes" ? "<a href=rules.php#warning class=altlink><img src=\"".$GLOBALS["PIC_BASE_URL"]."warned.gif\" alt=\"Warned\" border=0></a>" : "")) . " ($title)";
      }
      ...
      print("</td><td class=embedded width=1%><a href=\"#top\"><img src=\"".$GLOBALS["PIC_BASE_URL"]."top.gif\" border=0 alt='Top'></a></td></tr>");
  ...
  if ($action == "editpost")
  {
    ...
    print("<input type=hidden name=returnto value=\"" . htmlspecialchars($_SERVER["_REFERER"]) . "\">\n");
  ...
  if ($action == "viewforum")
  {
    ...
    print("<td class=embedded><img src=\"".$GLOBALS["PIC_BASE_URL"]."unlockednew.gif\" style='margin-right: 5px'></td><td class=embedded>New posts</td>\n");

    print("<td class=embedded><img src=\"".$GLOBALS["PIC_BASE_URL"]."locked.gif\" style='margin-left: 10px; margin-right: 5px'>" .
  ...
  if ($action == "viewunread")
  {
    ...
    while ($arr = mysql_fetch_assoc($res))
    {
      ...
      "<img src=\"".$GLOBALS["PIC_BASE_URL"]."unlockednew.gif\" style='margin-right: 5px'></td><td class=embedded>" .
...
*/
    ...
    $GLOBALS["PIC_BASE_URL"].$img.".gif\"></td><td class=embedded><a href=?action=viewforum&forumid=$forumid><b>$forumname</b></a><br>\n" .
