...
echo "<table cellpadding=\"4\" cellspacing=\"1\" border=\"0\" style=\"width:750px\" class=\"tableinborder\">\n".
	...
	"            <p><font color=\"red\">Beachte, dass Du nicht Deine eigene, mit Deinem PassKey versehene URL eintr&auml;gst.<br>Der PassKey des jew. Users wird vom Download-Script automatisch eingef&uuml;gt! Aus diesem Grund MUSSTDu den Torrent nach erfolgtem Upload noch einmal vom Tracker runterladen und diesen dann zum Seedenverwenden.</font></p>\n".
	...
	"			<input type=\"hidden\" name=\"MAX_FILE_SIZE\" value=\"" . $GLOBALS["MAX_TORRENT_SIZE"] . "\" />\n";
					...
					tr("Beschreibung", "<textarea name=\"descr\" rows=\"10\" cols=\"80\"></textarea><br><input type=\"checkbox\" name=\"stripasciiart\" value=\"1\" checked=\"checked\"> ASCII-Art automatisch entfernen<br><br>(HTML ist <b>nicht</b> erlaubt, benutze den <a href=tags.php>BBCode</a> zum Formatieren der Beschreibung)", 1);
					tr("Typ", $s, 1);
